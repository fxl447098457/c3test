...
Public Function BadPointerInRax(ByRef target As Long, ByVal addend As Long) As Long
    Asm
        ...
        add ecx, r9d
        lock cmpxchg [rax], ecx     ' ← 3042: 累加器 eax, 但 [rax] 里的 rax 不再是地址
        mov [Function], eax
    End Asm
End Function

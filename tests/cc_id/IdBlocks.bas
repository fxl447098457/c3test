...
' C03a (ai/022 D48): both implementation targets are real class modules of this project, and
' no block claims [ComCreatable(True)] -- this is a Type=Exe project, where that is refused.

...
Private Declare Function GdipCreatePath Lib "GdiPlus.dll" (ByVal mBrushMode As Long, ByRef mPath As LongPtr) As Long
...
Private Declare Function GdipDrawString Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mString As LongPtr, ByVal mLength As Long, ByVal mFont As LongPtr, ByRef mLayoutRect As RectF, ByVal mStringFormat As LongPtr, ByVal mBrush As LongPtr) As Long
...
Private Declare Function GdipMeasureString Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mString As LongPtr, ByVal mLength As Long, ByVal mFont As LongPtr, ByRef mLayoutRect As RectF, ByVal mStringFormat As LongPtr, ByRef mBoundingBox As RectF, ByRef mCodepointsFitted As Long, ByRef mLinesFilled As Long) As Long
...
Private Function DrawText(ByVal hGraphics As LongPtr, text As Variant, ByVal X As Single, ByVal Y As Single, ByVal Width As Single, ByVal Height As Single, oFont As StdFont, ByVal ForeColor As Long, Optional HAlign As Long, Optional VAlign As Long, Optional bWordWrap As Boolean, Optional Angle As Single) As Long
    Dim hBrush As LongPtr
    Dim hFontFamily As LongPtr
    Dim hFormat As LongPtr
    Dim layoutRect As RectF
...
'*1
Private Sub Draw()
    Dim hGraphics As LongPtr, hPath As LongPtr
...
Private Sub fShowToolTips(hGraphics As LongPtr)
    Dim i As Long, j As Long
    Dim sDisplay As String
...
Private Sub RoundRect(ByVal hGraphics As LongPtr, Rect As RectF, ByVal BackColor As Long, ByVal BorderColor As Long, ByVal Round As Single)

...
Public Property Get ChartOrientation() As ChartOrientation
    ChartOrientation = m_ChartOrientation
End Property

Public Property Let ChartOrientation(ByVal New_Value As ChartOrientation)
    m_ChartOrientation = New_Value
    PropertyChanged "ChartOrientation"
    Refresh
End Property
...
Private Function DrawText(ByVal hGraphics As LongPtr, ByVal text As String, ByVal X As Single, ByVal Y As Single, ByVal Width As Single, ByVal Height As Single, ByVal oFont As StdFont, ByVal ForeColor As Long, Optional HAlign As ucCB_TextAlignmentH, Optional VAlign As TextAlignmentV, Optional bWordWrap As Boolean, Optional Angle As Single) As Long
    Dim hBrush As LongPtr
    Dim hFontFamily As LongPtr
    Dim hFormat As LongPtr
    Dim layoutRect As RectF
...
Private Sub ShowToolTips(hGraphics As LongPtr, BarWidth As Single)
    Dim i As Long, j As Long
    Dim sDisplay As String

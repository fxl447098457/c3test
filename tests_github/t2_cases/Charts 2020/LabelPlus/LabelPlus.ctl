...
'-----------------------------------------------
Private Declare Function TlsGetValue Lib "kernel32.dll" (ByVal dwTlsIndex As Long) As LongPtr
Private Declare Function TlsSetValue Lib "kernel32.dll" (ByVal dwTlsIndex As Long, ByVal lpTlsValue As LongPtr) As Long
...
Private Declare Function GetModuleHandleA Lib "kernel32" (ByVal lpModuleName As String) As LongPtr
...
Private Declare Function WindowFromPoint Lib "user32.dll" (ByVal xPoint As Long, ByVal yPoint As Long) As LongPtr
...
Private Declare Function ScreenToClient Lib "user32.dll" (ByVal hwnd As LongPtr, ByRef lpPoint As POINTAPI) As Long
Private Declare Function SendMessage Lib "user32.dll" Alias "SendMessageA" (ByVal hwnd As LongPtr, ByVal wMsg As Long, ByVal wParam As LongPtr, ByRef lParam As Any) As LongPtr
...
Private Declare Function LoadCursor Lib "user32" Alias "LoadCursorA" (ByVal hInstance As LongPtr, ByVal lpCursorName As LongPtr) As LongPtr
Private Declare Function DestroyCursor Lib "user32" (ByVal hCursor As LongPtr) As Long
Private Declare Function SetCursor Lib "user32.dll" (ByVal hCursor As LongPtr) As LongPtr
...
Private Declare Function GdipLoadImageFromStream Lib "gdiplus" (ByVal Stream As Any, ByRef Image As LongPtr) As Long
...
Private Declare Function GdipDeleteGraphics Lib "gdiplus" (ByVal hGraphics As LongPtr) As Long
Private Declare Function GdipDrawImageRectRectI Lib "gdiplus" (ByVal hGraphics As LongPtr, ByVal hImage As Long, ByVal dstX As Long, ByVal dstY As Long, ByVal dstWidth As Long, ByVal dstHeight As Long, ByVal SrcX As Long, ByVal SrcY As Long, ByVal SrcWidth As Long, ByVal SrcHeight As Long, ByVal srcUnit As Long, Optional ByVal imageAttributes As LongPtr = 0, Optional ByVal Callback As LongPtr = 0, Optional ByVal CallbackData As LongPtr = 0) As Long
Private Declare Function GdipDisposeImageAttributes Lib "gdiplus" (ByVal imageattr As LongPtr) As Long
Private Declare Function GdipCreateImageAttributes Lib "gdiplus" (ByRef imageattr As LongPtr) As Long
Private Declare Function GdipSetImageAttributesColorMatrix Lib "gdiplus" (ByVal imageattr As LongPtr, ByVal ColorAdjust As Long, ByVal EnableFlag As Boolean, ByRef MatrixColor As COLORMATRIX, ByRef MatrixGray As COLORMATRIX, ByVal flags As Long) As Long
Private Declare Function GdipImageRotateFlip Lib "gdiplus" (ByVal Image As LongPtr, ByVal rfType As Long) As Long
...
Private Declare Function GdipSetSolidFillColor Lib "gdiplus" (ByVal Brush As LongPtr, ByVal ARGB As Long) As Long
Private Declare Function GdipCreatePen1 Lib "GdiPlus.dll" (ByVal mColor As Long, ByVal mWidth As Single, ByVal mUnit As Long, ByRef mPen As LongPtr) As Long
Private Declare Function GdipDrawLineI Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mPen As LongPtr, ByVal mX1 As Long, ByVal mY1 As Long, ByVal mX2 As Long, ByVal mY2 As Long) As Long
Private Declare Function GdipFillPolygonI Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mBrush As LongPtr, ByRef mPoints As Any, ByVal mCount As Long, ByVal mFillMode As Long) As Long
Private Declare Function GdipDrawPolygonI Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mPen As LongPtr, ByRef mPoints As Any, ByVal mCount As Long) As Long
Private Declare Function GdipCreatePath Lib "GdiPlus.dll" (ByRef mBrushMode As LongPtr, ByRef mPath As LongPtr) As Long
Private Declare Function GdipDeletePath Lib "GdiPlus.dll" (ByVal mPath As LongPtr) As Long
Private Declare Function GdipDrawPath Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mPen As LongPtr, ByVal mPath As LongPtr) As Long
Private Declare Function GdipFillPath Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mBrush As LongPtr, ByVal mPath As LongPtr) As Long
Private Declare Function GdipAddPathArcI Lib "GdiPlus.dll" (ByVal mPath As LongPtr, ByVal mX As Long, ByVal mY As Long, ByVal mWidth As Long, ByVal mHeight As Long, ByVal mStartAngle As Single, ByVal mSweepAngle As Single) As Long
Private Declare Function GdipAddPathLineI Lib "GdiPlus.dll" (ByVal mPath As LongPtr, ByVal mX1 As Long, ByVal mY1 As Long, ByVal mX2 As Long, ByVal mY2 As Long) As Long
Private Declare Function GdipDeletePen Lib "GdiPlus.dll" (ByVal mPen As LongPtr) As Long
Private Declare Function GdipCreateTexture Lib "GdiPlus.dll" (ByVal mImage As LongPtr, ByVal mWrapMode As Long, ByRef mTexture As LongPtr) As Long
Private Declare Function GdipClosePathFigures Lib "GdiPlus.dll" (ByVal mPath As LongPtr) As Long
Private Declare Function GdipBitmapUnlockBits Lib "GdiPlus.dll" (ByVal mBitmap As LongPtr, ByRef mLockedBitmapData As BitmapData) As Long
Private Declare Function GdipBitmapLockBits Lib "GdiPlus.dll" (ByVal mBitmap As LongPtr, ByRef mRect As RectL, ByVal mFlags As ImageLockMode, ByVal mPixelFormat As Long, ByRef mLockedBitmapData As BitmapData) As Long
Private Declare Function GdipGetImageHeight Lib "GdiPlus.dll" (ByVal mImage As LongPtr, ByRef mHeight As Long) As Long
Private Declare Function GdipGetImageWidth Lib "GdiPlus.dll" (ByVal mImage As LongPtr, ByRef mWidth As Long) As Long
Private Declare Function GdipDrawImageRectI Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mImage As LongPtr, ByVal mX As Long, ByVal mY As Long, ByVal mWidth As Long, ByVal mHeight As Long) As Long
Private Declare Function GdipCreateBitmapFromScan0 Lib "GdiPlus.dll" (ByVal mWidth As Long, ByVal mHeight As Long, ByVal mStride As Long, ByVal mPixelFormat As Long, ByVal mScan0 As LongPtr, ByRef mBitmap As LongPtr) As Long
Private Declare Function GdipGetImageGraphicsContext Lib "gdiplus" (ByVal Image As LongPtr, hGraphics As LongPtr) As Long
Private Declare Function GdipMeasureString Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mString As LongPtr, ByVal mLength As Long, ByVal mFont As LongPtr, ByRef mLayoutRect As RectF, ByVal mStringFormat As Long, ByRef mBoundingBox As RectF, ByRef mCodepointsFitted As Long, ByRef mLinesFilled As Long) As Long
Private Declare Function GdipCreateFont Lib "GdiPlus.dll" (ByVal mFontFamily As LongPtr, ByVal mEmSize As Single, ByVal mStyle As Long, ByVal mUnit As Long, ByRef mFont As LongPtr) As Long
Private Declare Function GdipDeleteFont Lib "GdiPlus.dll" (ByVal mFont As LongPtr) As Long
Private Declare Function GdipDrawString Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mString As LongPtr, ByVal mLength As Long, ByVal mFont As LongPtr, ByRef mLayoutRect As RectF, ByVal mStringFormat As Long, ByVal mBrush As LongPtr) As Long
Private Declare Function GdipSetPenMode Lib "GdiPlus.dll" (ByVal mPen As LongPtr, ByVal mPenMode As PenAlignment) As Long
Private Declare Function GdipCreateLineBrushFromRectWithAngleI Lib "GdiPlus.dll" (ByRef mRect As RectL, ByVal mColor1 As Long, ByVal mColor2 As Long, ByVal mAngle As Single, ByVal mIsAngleScalable As Long, ByVal mWrapMode As WrapMode, ByRef mLineGradient As LongPtr) As Long
Private Declare Function GdipCreateFontFamilyFromName Lib "gdiplus" (ByVal Name As LongPtr, ByVal fontCollection As LongPtr, fontFamily As LongPtr) As Long
Private Declare Function GdipDeleteFontFamily Lib "gdiplus" (ByVal fontFamily As LongPtr) As Long
Private Declare Function GdipAddPathString Lib "GdiPlus.dll" (ByVal mPath As LongPtr, ByVal mString As LongPtr, ByVal mLength As Long, ByVal mFamily As LongPtr, ByVal mStyle As Long, ByVal mEmSize As Single, ByRef mLayoutRect As RectF, ByVal mFormat As LongPtr) As Long
Private Declare Function GdipGetGenericFontFamilySerif Lib "gdiplus" (ByRef nativeFamily As LongPtr) As Long
Private Declare Function GdipGetGenericFontFamilySansSerif Lib "GdiPlus.dll" (ByRef mNativeFamily As LongPtr) As Long
Private Declare Function GdipCreateStringFormat Lib "gdiplus" (ByVal formatAttributes As Long, ByVal language As Integer, StringFormat As LongPtr) As Long
Private Declare Function GdipSetStringFormatFlags Lib "GdiPlus.dll" (ByVal mFormat As LongPtr, ByVal mFlags As StringFormatFlags) As Long
Private Declare Function GdipSetStringFormatHotkeyPrefix Lib "GdiPlus.dll" (ByVal mFormat As LongPtr, ByVal mHotkeyPrefix As HotkeyPrefix) As Long
Private Declare Function GdipSetStringFormatTrimming Lib "GdiPlus.dll" (ByVal mFormat As LongPtr, ByVal mTrimming As StringTrimming) As Long
Private Declare Function GdipSetStringFormatAlign Lib "gdiplus" (ByVal StringFormat As LongPtr, ByVal Align As StringAlignment) As Long
Private Declare Function GdipSetStringFormatLineAlign Lib "GdiPlus.dll" (ByVal mFormat As LongPtr, ByVal mAlign As StringAlignment) As Long
Private Declare Function GdipTranslateWorldTransform Lib "gdiplus" (ByVal graphics As LongPtr, ByVal dX As Single, ByVal dY As Single, ByVal Order As Long) As Long
Private Declare Function GdipRotateWorldTransform Lib "gdiplus" (ByVal graphics As LongPtr, ByVal Angle As Single, ByVal Order As Long) As Long
Private Declare Function GdipResetWorldTransform Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr) As Long
Private Declare Function GdipDeleteStringFormat Lib "GdiPlus.dll" (ByVal mFormat As LongPtr) As Long
Private Declare Function GdipCreateBitmapFromHBITMAP Lib "GdiPlus.dll" (ByVal mHbm As LongPtr, ByVal mhPal As LongPtr, ByRef mBitmap As LongPtr) As Long
Private Declare Function GdipCreateEffect Lib "gdiplus" (ByVal dwCid1 As Long, ByVal dwCid2 As Long, ByVal dwCid3 As Long, ByVal dwCid4 As Long, ByRef Effect As LongPtr) As Long
Private Declare Function GdipSetEffectParameters Lib "gdiplus" (ByVal Effect As LongPtr, ByRef params As Any, ByVal Size As Long) As Long
Private Declare Function GdipDeleteEffect Lib "gdiplus" (ByVal Effect As LongPtr) As Long
Private Declare Function GdipDrawImageFX Lib "gdiplus" (ByVal graphics As LongPtr, ByVal Image As LongPtr, ByRef Source As RectF, ByVal xForm As LongPtr, ByVal Effect As LongPtr, ByVal imageAttributes As LongPtr, ByVal srcUnit As Long) As Long
Private Declare Function GdipDrawPie Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mPen As LongPtr, ByVal mX As Single, ByVal mY As Single, ByVal mWidth As Single, ByVal mHeight As Single, ByVal mStartAngle As Single, ByVal mSweepAngle As Single) As Long
Private Declare Function GdipDrawArc Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mPen As LongPtr, ByVal mX As Single, ByVal mY As Single, ByVal mWidth As Single, ByVal mHeight As Single, ByVal mStartAngle As Single, ByVal mSweepAngle As Single) As Long
Private Declare Function GdipSetClipRectI Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr, ByVal mX As Long, ByVal mY As Long, ByVal mWidth As Long, ByVal mHeight As Long, ByVal mCombineMode As Long) As Long
Private Declare Function GdipResetClip Lib "GdiPlus.dll" (ByVal mGraphics As LongPtr) As Long
Private Declare Function GdipResetPath Lib "GdiPlus.dll" (ByVal mPath As LongPtr) As Long
...
Public Event PrePaint(hDC As LongPtr, X As Long, Y As Long)
Public Event PostPaint(ByVal hDC As LongPtr)
...
Dim hImgCaptionShadow As LongPtr
...
Public Sub Draw(ByVal hDC As LongPtr, ByVal hGraphics As LongPtr, ByVal PosX As Long, PosY As Long)
    Dim hPath As LongPtr
...
Private Function GDIP_AddPathString(ByVal hGraphics As LongPtr, X As Long, Y As Long, Width As Long, Height As Long, Optional ForShadow As Boolean, Optional GetMeasureString As Boolean) As Boolean
    Dim hPath As LongPtr
    Dim hPen As LongPtr
    Dim hBrush As LongPtr
...
Function DrawText(ByVal hDC As LongPtr, ByVal text As String, ByVal X As Long, ByVal Y As Long, ByVal Width As Long, ByVal Height As Long, ByVal oFont As StdFont, ByVal ForeColor As OLE_COLOR, Optional ByVal ColorOpacity As Integer = 100, Optional HAlign As CaptionAlignmentH, Optional VAlign As CaptionAlignmentV, Optional bWordWrap As Boolean) As Long
    Dim hBrush As LongPtr
    Dim hFontFamily As LongPtr
    Dim hFormat As LongPtr
    Dim layoutRect As RectF
...
Public Function GetWindowsDPI() As Double
    Dim hDC As LongPtr, LPX  As Double
    hDC = GetDC(0)
...
Private Sub CreateShadow()
    ...
    Dim hGraphics As LongPtr
    Dim hPath As LongPtr
    Dim hBrush As LongPtr, hPen As LongPtr
    Dim lWidth As Long, lHeight As Long
    Dim ShadowSize As Integer
...
Private Function DrawHotLine(hGraphics As LongPtr, hPath As LongPtr) ', ByVal PosX As Long, ByVal PosY As Long)
    Dim hBrush As LongPtr
    Dim X As Long, Y As Long
    Dim WW As Long, HH As Long
    Dim BW As Long
...
Private Sub DrawProgress(hGraphics As LongPtr, ByVal X As Long, ByVal Y As Long, ByVal Width As Long, ByVal Height As Long, ByVal Value As Long, ByVal Max As Long)
    Dim hPen As LongPtr
...
Private Sub DrawAcrylicBlur(hGraphics As LongPtr, hPath As LongPtr)
    Dim hBrush As LongPtr
    Dim hImage As LongPtr
...
Private Function CreateBrushTexture(hGraphics As LongPtr, hPath As LongPtr, ByVal X As Long, ByVal Y As Long, ByVal Width As Long, ByVal Height As Long) As LongPtr
    Dim hBrush As LongPtr
    Dim hImage As LongPtr
    Dim hGraphics2 As LongPtr, hImage2 As LongPtr
    Dim tMatrixColor    As COLORMATRIX, tMatrixGray    As COLORMATRIX
    Dim hAttributes As LongPtr
    Dim ReqWidth As Long, ReqHeight As Long
    Dim HScale As Double, VScale As Double
    Dim MyScale As Double
    Dim imgWidth As Long
...
Private Function CreateBlurShadowImage(ByVal hImage As LongPtr, ByVal Color As Long, blurDepth As Integer, _
                                        Optional ByVal Left As Long, Optional ByVal Top As Long, _
                                        Optional ByVal Width As Long, Optional ByVal Height As Long) As LongPtr
...
Public Property Let AutoSize(ByVal NewValue As Boolean)
    Dim hGraphics As LongPtr, hImage As LongPtr
    Dim lWidth As Long, lHeight As Long
    Dim lDif As Long
...
Private Function ManageGDIToken(ByVal projectHwnd As LongPtr) As LongPtr ' by LaVolpe
    ...
    Dim hwndGDIsafe As LongPtr                 'API window to monitor IDE shutdown
    ...
    Dim gToken As LongPtr                 'GDI+ instance token
...
Private Function RoundRectangle(X As Long, Y As Long, Width As Long, Height As Long, Optional Inflate As Boolean, Optional nn As Boolean) As LongPtr
...
Private Function LoadImageFromStream(ByRef bvData() As Byte, ByRef hImage As LongPtr) As Boolean
...
Public Function DrawLine(ByVal hDC As LongPtr, ByVal x1 As Long, ByVal y1 As Long, ByVal x2 As Long, ByVal y2 As Long, Optional ByVal oColor As OLE_COLOR = vbBlack, Optional ByVal Opacity As Integer = 100, Optional ByVal PenWidth As Integer = 1) As Boolean
...
Public Function Polygon(ByVal hDC As LongPtr, ByVal PenWidth As Long, ByVal oColor As OLE_COLOR, ByVal Opacity As Integer, ParamArray vPoints() As Variant) As Boolean
    Dim hGraphics As LongPtr, hBrush As LongPtr, hPen As LongPtr
    Dim lPoints() As Long
    Dim lCount As Long
    Dim i As Long
...
Public Property Get Image() As IPicture
    Dim DC As LongPtr, TempHdc As LongPtr
    Dim hBmp As LongPtr, OldhBmp As LongPtr
...
Private Function ObjFromPtr(ByVal pObj As LongPtr) As Object
    Dim obj As Object

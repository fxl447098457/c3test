...
Public Function DrawGradientArc(ByVal hGraphics As LongPtr, _
...
Private Sub Draw()
    ...
    Dim RectL As RectL
    Dim X As Long, Y As Long
    Dim hPen As LongPtr, hGraphics As LongPtr
    Dim hBrush As LongPtr
    Dim i As Single
    Dim iStep As Single
    ...
    If GdipCreateFromHDC(UserControl.hDC, hGraphics) <> GDIP_OK Then Exit Sub

...
> 更新日期：2026-09-11（091a-092x：无窗体 125 模块 bisect 基线 65 → **8**；提交 。**剩余 8 全部为非代码缺陷**（窗体假阳性 7 + 配置缺口 1）→ 无窗体 bisect 面已收敛。窗体 Release 崩溃仍为既有阻塞项，bisect 正则不含窗体）

### 最近修复摘要（092r-x：无窗体 bisect 基线 16 → **8**；提交 f799e55/b6ff125/7559ad2/50de9b7/bad7b27/ac69fc0/e0df780，2026-09-11）
...
- **残留 8 = C2065×5 + C2198×3**（**无代码缺陷**，全部为非缺陷项；092w/092x 已清 Demo_Database 506 与 cHttpServer 821）；其中 **7 个是窗体假阳性**（cLogs×5：`vb6_FLogs_Visible`/`FLogs` 未声明 + `vb6_cTimeUse_Show` 参数少；cLayer×2：`FLayer` 未声明 + `vb6_cCsv_ShowTo` 参数少）→ **无窗体 bisect 面已收敛**，余下 1 处为**配置/环境缺口**：
